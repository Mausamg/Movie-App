...
const LoginForm = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // No need to manually update state as the AuthProvider will handle it
    } catch (error) {
    ...
    <div className="flex items-center justify-center min-h-screen bg-neutral-700">
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-black">Welcome to Movieo</h1>
          <p className="mt-2  text-black">Sign in to access your account</p>
        </div>
